	...
	if (!isset($comienzo))
	  $comienzo = 0;
	     // Calcular el número total de filas de la tabla
	      $instruccion = "select * from detalle";
	 ...
	 <?php
	  ...
	  $instruccion = "select * from detalle order by id_pedido asc limit $comienzo, $num";
	  $consulta = mysqli_query($conn,$instruccion)
	   ...
	   ?>
			...
			<th width="75">Id Pedido</th>
			<th width="75">Id Producto</th>
	  ...
	  ?>				
						...
						<td width="75"><?php echo $f['id_pedido']?></td>
						<td width="75"><?php echo $f['id_producto']?></td>
						<td width="75"><?php echo $f['cantidad']?></td>
						<td width="75"><?php echo $f['nombre']?></td>
