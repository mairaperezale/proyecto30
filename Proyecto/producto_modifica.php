...
<html>
<head>
<title>Modificar Prodcuto</title>
...
//include_once 'conecto.php';
 ...
 if (!isset($comienzo))
     ...
     // $consulta = mysqli_query($instruccion,$conn)
      ...
      if ($nfilas > 0)
      {
       // cantidad de filas a mostrar en una pagina.
         ...
         print ("<div style='margin-left:20px'>Muestra productos desde " . ($comienzo + 1) . " a ");
  ...
  $instruccion = "select * from producto order by codigo_producto desc limit $comienzo, $num";
  $consulta = mysqli_query($conn,$instruccion) or die  ("fallo en la consulta");
           // Mostrar consulta
      $nfilas = mysqli_num_rows($consulta);
      if ($nfilas > 0)
      {
         ...
         print ("<TR>\n");
         print ("<TH WIDTH='75'>Codigo</TH>\n");
         print ("<TH WIDTH='140'>Nombre</TH>\n");
         print ("<TH WIDTH='75'>Precio</TH>\n");
         print ("<TH WIDTH='75'>Cantidad</TH>\n");
         ...
         for ($i=0; $i<$nfilas; $i++)
         {
            ...
            print ("<TR>\n");
			$prueba=$resultado['codigo_producto'];
         ...
         print ("<TD>&nbsp;</TD>\n");
		 print ("<TD>" ."<a href=producto_editar.php?codigo_producto=".$prueba."><img src='imagen/modificar.png' border='0%' width='80px' alt='editar'> </a>". "</TD>\n");   
