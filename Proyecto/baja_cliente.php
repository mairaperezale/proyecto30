...
<br>
<br>
<form action="pagina_baja.php" method="post">
<br><br>
<label><b>Ingrese numero de cliente a dar de BAJA:</b></label>
<input type="text" name="id_cliente" id="id_cliente" size="10"  maxlength="8" >
<br>
<div align="center">
<br><br>
